...
$order = $conn->query("SELECT o.*,concat(c.firstname,' ',c.lastname) as client, c.id AS c_id FROM `orders` o inner join clients c on c.id = o.client_id where o.id = '{$_GET['id']}' ");
if($order->num_rows > 0){
...
<div class="row">
    ...
    <div class="col-md-3" style="color: #fff;">
        ...
        <img src="../../<?php echo $image ?>" width="100%" style="margin-bottom: 10px;">
    </div>
<?php }else{} ?>

    <div class="<?php if($payment_method == 'gcash'){ echo "col-md-9"; }else{ echo "col-md-12"; } ?>">
        ...
        <div class="row">
            ...
            <div class="col-6 row row-cols-2">
                ...
                <div class="col">
                    ...
                    <button type="button" id="send_receipt" class="btn btn-sm btn-flat btn-primary">Send Receipt</button>
                </div>
                <?php endif; ?>
...
<script>
    $(function(){
        ...
        $('#send_receipt').click(function(){
            uni_modal("Send Receipt", "./orders/send_receipt.php?c_id=<?php echo $c_id ?>&status=<?php echo $status ?>&oid=<?php echo $id ?>")
        })
    })
</script>